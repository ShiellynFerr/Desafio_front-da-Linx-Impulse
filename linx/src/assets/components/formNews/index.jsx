...
import { BoxFormNews, BoxInputs, BoxText } from './style';
 ...
 <BoxText>
 <h6>Quer que seus amigos também ganhem a lista personalizada deles? Preencha agora!</h6>
 </BoxText>
 <BoxInputs>
  <InputForm label="Nome do seu amigo:" id="nomeAmigo"/>
  <InputForm label="E-mail" id="emailAmigo"/>
 </BoxInputs>
